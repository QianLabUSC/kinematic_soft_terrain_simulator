...
// CHECK THIS FILE FOR A GUIDE: https://docs.google.com/document/d/1RbRSnkUz_ySGR83BVPYJtyHfjVE6aKPGtS-GQ1XOLBI/edit?usp=sharing
...
double test(int argc, char* argv[], double bodymass, double legmass,
    ...
    mterrain.SetPlotType(vehicle::SCMTerrain::PLOT_SINKAGE, 0, 0.1);
    // mterrain.SetPlotType(vehicle::SCMTerrain::PLOT_PRESSURE, 0, 1000);
    ...
    std::string test_name = "simple_success";
    ...
    double turn_threshold = 0.261799; // 15 deg
    double turn_speed = 0.5 * M_PI * gait_frequency;
