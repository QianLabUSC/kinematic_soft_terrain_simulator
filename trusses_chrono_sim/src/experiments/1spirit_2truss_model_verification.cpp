...
float position_epsilon = 0.000005;
float orientation_epsilon = 0.00005;
...
int main(int argc, char* argv[]) {
    ...
    spirit0->LockTrussEndPosition(1, ChVector3d(.5, -.5, .25));
    ...
    SetpointController trussController(init_truss_length, .1, 0, init_truss_length); //Initial position, init velocity, min pos, max pos
