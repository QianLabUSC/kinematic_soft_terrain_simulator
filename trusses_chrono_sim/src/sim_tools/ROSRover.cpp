#include "sim_tools/ROSRover.h"
  ...
  ROSRover::ROSRover(const std::string &node_name) : Node(node_name){ 
    ...
    set_joint_pos_sub_ = this->create_subscription<std_msgs::msg::Float32MultiArray>(
      ...
      std::bind(&ROSRover::set_joint_pos_callback, this, std::placeholders::_1));

    set_joint_PID_sub_ = this->create_subscription<std_msgs::msg::Float32MultiArray>(
      node_name+"/set_joint_PID", 10, 
      std::bind(&ROSRover::set_joint_PID_callback, this, std::placeholders::_1));

    set_truss_lengths_sub_ = this->create_subscription<std_msgs::msg::Float32MultiArray>(
      node_name+"/set_truss_lengths", 10, 
      std::bind(&ROSRover::set_truss_lengths_callback, this, std::placeholders::_1));

  }

  // Method to publish pose value
  void ROSRover::publish_pose(ChVector3d position, ChQuaterniond quat)
  {
  ...
  void ROSRover::publish_joint_angles(std::vector<double>& angles){
  ...
  void ROSRover::publish_toe_pos(std::vector<ChVector3d>& positions){
      auto message = std_msgs::msg::Float32MultiArray();
  ...
  void ROSRover::publish_truss_lengths(std::vector<double>& lengths){
      auto message = std_msgs::msg::Float32MultiArray();
  ...
  void ROSRover::set_joint_pos_callback(const std::shared_ptr<const std_msgs::msg::Float32MultiArray> msg){set_joint_pos_msg = *msg; }
  void ROSRover::set_joint_PID_callback(const std::shared_ptr<const std_msgs::msg::Float32MultiArray> msg){set_joint_PID_msg = *msg; }
  void ROSRover::set_truss_lengths_callback(const std::shared_ptr<const std_msgs::msg::Float32MultiArray> msg){set_truss_lengths_msg = *msg; }